...
object MedicineDataMapper {
    fun fromDataToDomain(medicine: MedicineData): Medicine {
        return Medicine(
            ...
            forWhoms = medicine.forWhoms?.split(SEPARATOR) ?: emptyList(),
            forWhomsVerification = medicine.forWhomsVerification?.split(SEPARATOR_FOR_FTS4) ?: emptyList(),
    ...
    fun fromDomainToData(medicine: Medicine): MedicineData {
        return MedicineData(
            ...
            forWhoms = medicine.forWhoms.joinToStringOrNull(SEPARATOR),
            forWhomsVerification = medicine.forWhomsVerification.joinToStringOrNull(SEPARATOR_FOR_FTS4),
