...
data class Medicine (
    ...
    val forWhoms: List<String> = emptyList(), //Для кого лекарство (для показа)
    val forWhomsVerification: List<String> = emptyList(), //Для кого лекарство без пробелов и большом регистре (для поиска)
